...
- The site should have at least five animations of which one has to be a preloader animation.
...
- The landing page should be optimized and have the highest score possible at [web.dev](https://web.dev/)​
